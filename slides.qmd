---
title: "Will it fit? New methods and datasets for integrating diverse datasets for transport planning"
subtitle: "Data Driven 2025<br>Reproducible slides: [robinlovelace.github.io/datadriven25](https://robinlovelace.github.io/datadriven25). Source code: [github.com](https://github.com/robinlovelace/datadriven25)"
format: 
  clean-revealjs:
    self-contained: true
...
## Cross-sectional width guidance

![](images/paste-11.png)

## Streetspace layer

To be launched soon [npt.scot](https://www.npt.scot).

[Contains OS data © Crown copyright and database rights 2025 OS licence number 100046668.]{style="font-size: small;"}

![](images/paste-3.png)

## Example with limited edge-to-edge width

![](images/paste-13.png)

## Validation

Source: [Google StreetView](https://www.google.com/maps/place/55%C2%B057'00.2%22N+3%C2%B011'15.0%22W/@55.9500737,-3.187801,63m/data=!3m1!1e3!4m10!1m5!3m4!2zNTXCsDU3JzAwLjkiTiAzwrAxMCc1OS4zIlc!8m2!3d55.950256!4d-3.183149!3m3!8m2!3d55.950054!4d-3.187507?entry=ttu&g_ep=EgoyMDI1MDMxMi4wIKXMDSoJLDEwMjExNDUzSAFQAw%3D%3D)
...
graph TD
  ...
  subgraph output_layer ["Output Layer"]
    direction TB
    OSM_Los["Level of Service layer (OSM)"]
    OS_OpenRoads["Streetspace layer (OS OpenRoads)"]
...
library(osmactive)
case_study_location_area = zonebuilder::zb_zone("pall mall london", n_circles = 1) |>
  sf::st_union()
case_study_centroid = sf::st_centroid(case_study_location_area)
# ?osmextract::oe_get
osm = get_travel_network(case_study_location_area, boundary = case_study_location_area, boundary_type = "clipsrc")
...
fs::file_size("cycle_network.geojson")
```
...
plot_osm_tmap(cycle_net) +
  tmap::qtm(case_study_centroid)
```

![](images/cycle_net_pall_mall.png)

## Interactive [osmactive](https://github.com/nptscot/osmactive/releases/download/v0.1/cycle_net_bristol.html) plots with ['geocompx'](https://geocompx.org) stack
...
m
# tmap::tmap_save(m, "images/cycle_net_pall_mall.png")
```

See [Chapter 9 of Geocomputation with R at geocompx.org](https://r.geocompx.org/adv-map) for more details [@lovelace2025].
...
Reproducible slides: [robinlovelace.github.io/datadriven25](https://robinlovelace.github.io/datadriven25)

# Plugs {visibility="uncounted"}

## Transport data mini-hack, 8th May **one week today** {visibility="uncounted"}
...
## Transport Data Science workshop, 18th-19th September {visibility="uncounted"}
...
# Further information {visibility="uncounted"}

## Key features of the NPT {visibility="uncounted"}
...
## Live demo {visibility="uncounted"}

See [www.npt.scot](https://www.npt.scot) for live demo of production version of NPT.

<!-- gif: -->

![](images/screencast-clos.gif)

## Road width measurements {visibility="uncounted"}
...
## Minimum cycle track and buffer widths {visibility="uncounted"}
...
## Bus routes and road traffic assumptions {visibility="uncounted"}
